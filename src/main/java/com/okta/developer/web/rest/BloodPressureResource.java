...
public class BloodPressureResource {
    ...
    /**
     * {@code PATCH  /blood-pressures} : Updates given fields of an existing bloodPressure.
     *
     * @param bloodPressure the bloodPressure to update.
     * @return the {@link ResponseEntity} with status {@code 200 (OK)} and with body the updated bloodPressure,
     * or with status {@code 400 (Bad Request)} if the bloodPressure is not valid,
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/blood-pressures", consumes = "application/merge-patch+json")
    public ResponseEntity<BloodPressure> partialUpdateBloodPressure(@NotNull @RequestBody BloodPressure bloodPressure)
        throws URISyntaxException {
        log.debug("REST request to update BloodPressure partially : {}", bloodPressure);
        if (bloodPressure.getId() == null) {
            throw new BadRequestAlertException("Invalid id", ENTITY_NAME, "idnull");
        }
