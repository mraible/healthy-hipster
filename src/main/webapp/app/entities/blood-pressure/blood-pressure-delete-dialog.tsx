...
export const BloodPressureDeleteDialog = (props: IBloodPressureDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="healthyHipsterApp.bloodPressure.delete.question">
        <Translate contentKey="healthyHipsterApp.bloodPressure.delete.question" interpolate={{ id: bloodPressureEntity.id }}>
