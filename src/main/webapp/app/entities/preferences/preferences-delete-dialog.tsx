...
export const PreferencesDeleteDialog = (props: IPreferencesDeleteDialogProps) => {
  useEffect(() => {
  ...
  const confirmDelete = () => {
    props.deleteEntity(props.preferencesEntity.id);
  };
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="healthyHipsterApp.preferences.delete.question">
        <Translate contentKey="healthyHipsterApp.preferences.delete.question" interpolate={{ id: preferencesEntity.id }}>
