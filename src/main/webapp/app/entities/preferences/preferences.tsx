  ...
  return (
    <div>
      <h2 id="preferences-heading">
        <Translate contentKey="healthyHipsterApp.preferences.home.title">Preferences</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="healthyHipsterApp.preferences.home.createLabel">Create new Preferences</Translate>
        </Link>
      </h2>
        ...
        {preferencesList && preferencesList.length > 0 ? (
            ...
            <tbody>
              {preferencesList.map((preferences, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    <Translate contentKey={`healthyHipsterApp.Units.${preferences.weightUnits}`} />
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="healthyHipsterApp.preferences.home.notFound">No Preferences found</Translate>
            </div>
          )
        )}
      </div>
