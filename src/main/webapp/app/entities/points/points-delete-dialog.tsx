...
export const PointsDeleteDialog = (props: IPointsDeleteDialogProps) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="healthyHipsterApp.points.delete.question">
        <Translate contentKey="healthyHipsterApp.points.delete.question" interpolate={{ id: pointsEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="jhi-confirm-delete-points" color="danger" onClick={confirmDelete}>
