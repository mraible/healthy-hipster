...
class BloodPressureResourceIT {
    ...
    void getAllBloodPressures() throws Exception {
        ...
        restBloodPressureMockMvc
            .perform(get("/api/blood-pressures?sort=id,desc"))
    ...
    void getBloodPressure() throws Exception {
        ...
        restBloodPressureMockMvc
            .perform(get("/api/blood-pressures/{id}", bloodPressure.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingBloodPressure() throws Exception {
        // Get the bloodPressure
        restBloodPressureMockMvc.perform(get("/api/blood-pressures/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }

    @Test
    @Transactional
    void updateBloodPressure() throws Exception {
        // Initialize the database
        bloodPressureRepository.saveAndFlush(bloodPressure);
    ...
    @Test
    @Transactional
    void updateNonExistingBloodPressure() throws Exception {
        int databaseSizeBeforeUpdate = bloodPressureRepository.findAll().size();
    ...
    @Test
    @Transactional
    void partialUpdateBloodPressureShouldThrown() throws Exception {
        // Update the bloodPressure without id should throw
        BloodPressure partialUpdatedBloodPressure = new BloodPressure();
    ...
    void deleteBloodPressure() throws Exception {
        ...
        restBloodPressureMockMvc
            .perform(delete("/api/blood-pressures/{id}", bloodPressure.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
    ...
    void searchBloodPressure() throws Exception {
        ...
        restBloodPressureMockMvc
            .perform(get("/api/_search/blood-pressures?query=id:" + bloodPressure.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(bloodPressure.getId().intValue())))
            .andExpect(jsonPath("$.[*].timestamp").value(hasItem(sameInstant(DEFAULT_TIMESTAMP))))
