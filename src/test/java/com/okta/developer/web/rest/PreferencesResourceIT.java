...
class PreferencesResourceIT {
    ...
    void getAllPreferences() throws Exception {
        ...
        restPreferencesMockMvc
            .perform(get("/api/preferences?sort=id,desc"))
    ...
    void getPreferences() throws Exception {
        ...
        // Get the preferences
        restPreferencesMockMvc
            .perform(get("/api/preferences/{id}", preferences.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
    ...
    void getNonExistingPreferences() throws Exception {
        // Get the preferences
        restPreferencesMockMvc.perform(get("/api/preferences/{id}", Long.MAX_VALUE)).andExpect(status().isNotFound());
    }
    ...
    @Test
    @Transactional
    void updateNonExistingPreferences() throws Exception {
        int databaseSizeBeforeUpdate = preferencesRepository.findAll().size();
    ...
    @Test
    @Transactional
    void partialUpdatePreferencesShouldThrown() throws Exception {
        // Update the preferences without id should throw
        Preferences partialUpdatedPreferences = new Preferences();
    ...
    void deletePreferences() throws Exception {
        ...
        restPreferencesMockMvc
            .perform(delete("/api/preferences/{id}", preferences.getId()).with(csrf()).accept(MediaType.APPLICATION_JSON))
    ...
    void searchPreferences() throws Exception {
        ...
        restPreferencesMockMvc
            .perform(get("/api/_search/preferences?query=id:" + preferences.getId()))
            .andExpect(status().isOk())
            .andExpect(content().contentType(MediaType.APPLICATION_JSON_VALUE))
            .andExpect(jsonPath("$.[*].id").value(hasItem(preferences.getId().intValue())))
            .andExpect(jsonPath("$.[*].weeklyGoal").value(hasItem(DEFAULT_WEEKLY_GOAL)))
