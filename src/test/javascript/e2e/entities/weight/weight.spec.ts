...
describe('Weight e2e test', () => {
  ...
  it('should load create Weight page', async () => {
    ...
    expect(await weightUpdatePage.getPageTitle().getAttribute('id')).to.match(/healthyHipsterApp.weight.home.createOrEditLabel/);
  ...
  it('should delete last Weight', async () => {
    ...
    expect(await weightDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/healthyHipsterApp.weight.delete.question/);
