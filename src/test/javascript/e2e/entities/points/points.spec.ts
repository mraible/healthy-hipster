...
describe('Points e2e test', () => {
  ...
  it('should load create Points page', async () => {
    ...
    expect(await pointsUpdatePage.getPageTitle().getAttribute('id')).to.match(/healthyHipsterApp.points.home.createOrEditLabel/);
  ...
  it('should delete last Points', async () => {
    ...
    expect(await pointsDeleteDialog.getDialogTitle().getAttribute('id')).to.match(/healthyHipsterApp.points.delete.question/);
